...
public class T extends Stone {

	private static final SquareColor COLOR = SquareColor.PURPLE;

	/**
	 * Constructs a stone of type {@link T}.
	 * @param x the x coordinate of the main robot
	 * @param y the y coordinate of the main robot
	 */
	public T(TetrisGame game, int x, int y) {
		super(game);
		...
		// . 0 . | . 1 . | . . . | . 3 . //
		///////////////////////////////////
		robots[0] = new SquareRobot(this, x, y - 1, COLOR, Vector.of(1, 1), Vector.of(-1, 1), Vector.of(-1, -1), Vector.of(1, -1));
